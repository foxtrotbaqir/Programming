...
void print_three_accounts(const Account& a1, const Account& a2, const Account& a3) // a1,a2,a3 are just references for current_account, savings_account and credit account.
{
    cout << endl;
